...
public class BrokerController {
    ...
    public void registerProcessor() {
        ...
        //默认都是使用SEND_MESSAGE_V2 这个就是Message的头更加精简 （a =? b=? ,c=？ d=?）
        // SEND_MESSAGE   发送 header属性（name =? value=?）
        ...
        //消费消息：PULL_MESSAGE  拉取消息 （客户端推模式底层实现也是基于拉模式）
