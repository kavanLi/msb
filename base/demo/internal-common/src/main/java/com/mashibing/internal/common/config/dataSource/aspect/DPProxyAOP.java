package com.mashibing.internal.common.config.dataSource.aspect;
...
import com.mashibing.internal.common.config.dataSource.config.DataSourceConfig;
...
public class DPProxyAOP {
    ...
    @Around("@annotation(com.mashibing.internal.common.config.dataSource.annotation.ConfigDB)")
    ...
    @Around("@annotation(com.mashibing.internal.common.config.dataSource.annotation.ReportDB)")
