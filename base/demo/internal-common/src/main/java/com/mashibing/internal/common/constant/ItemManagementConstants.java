...
public class ItemManagementConstants {
    ...
    public static String BOOLEAN_STATUS = "true-是 0-否";
    ...
    public enum BooleanStatus {
        ...
        BooleanStatus(Boolean code, String desc) {
            this.code = code;
            this.desc = desc;
        }
        ...
        public static BooleanStatus of(Boolean code) {
        ...
        public static Boolean exists(Boolean code) {
            for (BooleanStatus status : BooleanStatus.values()) {
                if (status.code == code) {
                    return true;
                }
            ...
            //throw new SmartyunstException(ServerRespCode.ERROR_PARAM, ItemManagementConstants.YCH_ITEM_STATUS + "参数不合法！");
        }
    }
    ...
    public enum MchtOrderScene {
        ...
        public static Boolean exists(String code) {
            ...
            //throw new SaasYunstException(ServerRespCode.ERROR_PARAM, ItemManagementConstants.MCHT_ORDER_SCENE + "参数不合法！");
            return false;
        }
    }
    ...
    public enum ItemStatus {
        ...
        public static Boolean exists(int code) {
            ...
            //throw new SaasYunstException(ServerRespCode.ERROR_PARAM, ItemManagementConstants.YCH_ITEM_STATUS + "参数不合法！");
            return false;
        }
    }
    ...
    public enum ItemScene {
        ...
        public static Boolean exists(int code) {
            ...
            //throw new SaasYunstException(ServerRespCode.ERROR_PARAM, ItemManagementConstants.YCH_ITEM_SCENE + "参数不合法！");
            return false;
        }
    }
    ...
    public enum ItemTier {
        ...
        public static Boolean exists(int code) {
            ...
            //throw new SaasYunstException(ServerRespCode.ERROR_PARAM, ItemManagementConstants.YCH_ITEM_TIER + "参数不合法！");
            return false;
        }
    }
