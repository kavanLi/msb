...
import com.mashibing.internal.common.config.easyExcel.converter.YchReconEnumConverter;
...
@EqualsAndHashCode
@ColumnWidth(25)
public class YchBillFlowReconDownloadData {
     ...
     * 账单总笔数
     */
    @ExcelProperty("汇总账单总笔数")
    private Long billTransCount;

    /**
     * 价格，单位：分
     */
    @ExcelProperty(value = "汇总账单总金额（元）", converter = LongFormatConverter.class)
    private Long billTotalAmount;

    /**
     * 价格，单位：分
     */
    @ExcelProperty(value = "汇总账单已付总金额（元）", converter = LongFormatConverter.class)
    private Long billTotalPaidAmount;
