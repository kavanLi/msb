    ...
    public synchronized void start() throws MQClientException {
        switch (this.serviceState) {//刚刚创建
            case CREATE_JUST:
                ...
                //TODO 这个实例在一个JVM中消费者和生产者共用，MQClientManager中维护了一个factoryTable，类型为ConcurrentMap，保存了clintId和MQClientInstanc
                ...
                //TODO 7.消费进度存储，如果是集群模式，使用远程存储RemoteBrokerOffsetStore，如果是广播模式，则使用本地存储LocalFileOffsetStore
