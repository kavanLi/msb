...
public class TraceDataEncoder {
    ...
    /**
     * Resolving traceContext list From acl data String
     *
     * @param traceData
     * @return
     */
    ...
    /**
     * Encoding the acl context into data strings and keyset sets
     *
     * @param ctx
     * @return
     */
    public static TraceTransferBean encoderFromContextBean(TraceContext ctx) {
        ...
        //build message acl of the transfering entity content bean
