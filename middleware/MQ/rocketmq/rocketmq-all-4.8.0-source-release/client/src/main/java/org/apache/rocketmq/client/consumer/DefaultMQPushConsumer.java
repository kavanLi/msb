...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
    ...
    /**
     * Constructor specifying consumer group and enabled msg acl flag.
     *
     * @param consumerGroup Consumer group.
     * @param enableMsgTrace Switch flag instance for message acl.
     */
    ...
    /**
     * Constructor specifying consumer group, enabled msg acl flag and customized acl topic name.
     *
     * @param consumerGroup Consumer group.
     * @param enableMsgTrace Switch flag instance for message acl.
     * @param customizedTraceTopic The name value of message acl topic.If you don't config,you can use the default acl topic name.
     */
    ...
    /**
     * Constructor specifying consumer group, RPC hook, message queue allocating algorithm, enabled msg acl flag and customized acl topic name.
     *
     * @param consumerGroup Consume queue.
     * @param rpcHook RPC hook to execute before each remoting command.
     * @param allocateMessageQueueStrategy message queue allocating algorithm.
    ...
    /**
     * Constructor specifying namespace, consumer group, RPC hook, message queue allocating algorithm, enabled msg acl flag and customized acl topic name.
     *
     * @param namespace Namespace for this MQ Producer instance.
     * @param consumerGroup Consume queue.
     * @param rpcHook RPC hook to execute before each remoting command.
