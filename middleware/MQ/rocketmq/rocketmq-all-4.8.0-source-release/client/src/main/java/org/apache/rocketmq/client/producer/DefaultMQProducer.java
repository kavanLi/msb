...
public class DefaultMQProducer extends ClientConfig implements MQProducer {
     ...
     * @param customizedTraceTopic The name value of message acl topic.If you don't config,you can use the default
     * acl topic name.
     */
    ...
    /**
     * Constructor specifying producer group and enabled msg acl flag.
     *
     * @param producerGroup Producer group, see the name-sake field.
     * @param enableMsgTrace Switch flag instance for message acl.
     */
    ...
    /**
     * Constructor specifying producer group, enabled msgTrace flag and customized acl topic name.
     *
     * @param producerGroup Producer group, see the name-sake field.
     * @param enableMsgTrace Switch flag instance for message acl.
     * @param customizedTraceTopic The name value of message acl topic.If you don't config,you can use the default
    ...
    /**
     * Constructor specifying namespace, producer group, RPC hook, enabled msgTrace flag and customized acl topic
     * name.
     *
     * @param namespace Namespace for this MQ Producer instance.
     * @param producerGroup Producer group, see the name-sake field.
